...
"""
        ...
        self.assertIsInstance(result, HTMLNode)
        self.assertEqual(result.tag, "div")
        self.assertEqual(len(result.children), 2)
        self.assertIsInstance(result.children[0], HTMLNode)
        self.assertEqual(result.children[0].tag, "p")
        self.assertIsInstance(result.children[1], HTMLNode)
...
"""
        ...
        self.assertIsInstance(result.children[2], HTMLNode)
        self.assertEqual(result.children[2].tag, "h3")
        self.assertIsInstance(result.children[3], HTMLNode)
        self.assertEqual(result.children[3].tag, "h4")
        self.assertIsInstance(result.children[4], HTMLNode)
        self.assertEqual(result.children[4].tag, "h5")
        self.assertIsInstance(result.children[5], HTMLNode)
